        # Registry First Rct Meta: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/registry-first-rct-meta.git

        ## Objective

        Registry-First RCT Meta implements a registry-first approach to meta-analysis, using pre-registered protocols to pre-specify synthesis choices before evidence collection.
        ...
        - Code: https://github.com/mahmood726-cyber/registry-first-rct-meta.git
